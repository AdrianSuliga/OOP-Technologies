...
public final class SerializablePersistenceManager implements PersistenceManager {
    ...
    public void saveTeachers(List<Teacher> teachers) {
        ...
        log.log("Saving teachers to " + teachersStorageFileName);
    ...
    public List<Teacher> loadTeachers() {
        ...
        log.log("Loading teachers from " + teachersStorageFileName);
    ...
    public void saveClasses(List<SchoolClass> classes) {
        ...
        log.log("Saving classes to " + classStorageFileName);
    ...
    public List<SchoolClass> loadClasses() {
        ...
        log.log("Loading classes from " + classStorageFileName);
